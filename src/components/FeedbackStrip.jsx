    ...
    <section className="bg-[#ABA293] py-20 border-t border-b border-[#9d9484]">
      ...
      <div className="relative overflow-hidden mb-12">
        <div className="flex gap-8 animate-feedback-scroll px-16 w-max">
          {[...feedbacks, ...feedbacks].map((item, index) => (
            <div
              key={index}
              className="min-w-[260px] px-5 py-4 rounded-2xl bg-[#ABA293] text-[#592219] shadow-[6px_6px_14px_#8f887a,-6px_-6px_14px_#c7bfa9]"
            >
      ...
      <div className="flex justify-center">
        <button
          ...
          className="px-10 py-4 rounded-2xl text-sm font-semibold text-[#592219] bg-[#ABA293] shadow-[inset_6px_6px_14px_#8f887a,inset_-6px_-6px_14px_#c7bfa9] hover:scale-105 transition"
        >
